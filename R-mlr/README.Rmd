...
PCA helps compress spectra data and reduce number of covariates [@chang2001near].
...
To remove bias in spectra, convert to [1st derivative](https://cran.r-project.org/web/packages/prospectr/vignettes/prospectr.html#derivatives) as this helps increase accuracy of calibration models [@rs12223765]:
