...
> Please note that the soil properties indication follows the export name. In addition, check [fitted_models_performance_v1.2.csv](out/fitted_models_performance_v1.2.csv) for the complete list of models of each soil property as some spectra types are not completely available. More importantly, for natural-log soil properties, the upper and lower bands were estimated before the back-transformation.
