...
Final evaluation was performed with external (`outer`) 10-fold cross validation of the final models using root mean square error (`rmse`), mean error (`bias`), R squared (`rsq`), Lin's concordance correlation coefficient (`ccc`), and ratio of performance to the interquartile range (`rpiq`).
